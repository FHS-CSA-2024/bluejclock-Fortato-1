...
public class ClockDisplaySeconds
{
    ...
    private NumberDisplaySeconds hours;
    private NumberDisplaySeconds minutes;
    private NumberDisplaySeconds seconds;
    ...
    public ClockDisplaySeconds(){
        hours = new NumberDisplaySeconds(24);
        minutes = new NumberDisplaySeconds(60);
        seconds = new NumberDisplaySeconds(60);
        updateDisplay();
    }
